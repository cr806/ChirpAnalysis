...
for file1, file2, column in file_details:
    ...
    data_filename1 = f'Libra_Data_20230810-000004_ROI2_{file1}_NEWDATA.csv'
    data_filename2 = f'Libra_Data_20230810-000004_ROI2_{file2}_NEWDATA.csv'
